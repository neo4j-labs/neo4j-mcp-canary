...
// Source: github.com/neo4j-labs/neo4j-mcp-canary/internal/analytics (interfaces: Service,HTTPClient)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_analytics.go -package=analytics_mocks -typed github.com/neo4j-labs/neo4j-mcp-canary/internal/analytics Service,HTTPClient
//
...
func (m *MockService) NewStartupEvent(transportMode config.TransportMode, tlsEnabled bool, mcpServer string, connectionMode string) analytics.TrackEvent {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewStartupEvent", transportMode, tlsEnabled, mcpServer, connectionMode)
	ret0, _ := ret[0].(analytics.TrackEvent)
	return ret0
}

// NewStartupEvent indicates an expected call of NewStartupEvent.
func (mr *MockServiceMockRecorder) NewStartupEvent(transportMode, tlsEnabled, mcpServer, connectionMode any) *MockServiceNewStartupEventCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewStartupEvent", reflect.TypeOf((*MockService)(nil).NewStartupEvent), transportMode, tlsEnabled, mcpServer, connectionMode)
...
// Do rewrite *gomock.Call.Do
func (c *MockServiceNewStartupEventCall) Do(f func(config.TransportMode, bool, string, string) analytics.TrackEvent) *MockServiceNewStartupEventCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceNewStartupEventCall) DoAndReturn(f func(config.TransportMode, bool, string, string) analytics.TrackEvent) *MockServiceNewStartupEventCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// NewToolEvent mocks base method.
func (m *MockService) NewToolEvent(toolsUsed string, success bool, vectorInfo *analytics.ToolVectorInfo, outputFormat config.OutputFormat) analytics.TrackEvent {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewToolEvent", toolsUsed, success, vectorInfo, outputFormat)
	ret0, _ := ret[0].(analytics.TrackEvent)
	return ret0
}

// NewToolEvent indicates an expected call of NewToolEvent.
func (mr *MockServiceMockRecorder) NewToolEvent(toolsUsed, success, vectorInfo, outputFormat any) *MockServiceNewToolEventCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewToolEvent", reflect.TypeOf((*MockService)(nil).NewToolEvent), toolsUsed, success, vectorInfo, outputFormat)
...
// Do rewrite *gomock.Call.Do
func (c *MockServiceNewToolEventCall) Do(f func(string, bool, *analytics.ToolVectorInfo, config.OutputFormat) analytics.TrackEvent) *MockServiceNewToolEventCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceNewToolEventCall) DoAndReturn(f func(string, bool, *analytics.ToolVectorInfo, config.OutputFormat) analytics.TrackEvent) *MockServiceNewToolEventCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
